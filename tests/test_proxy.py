...
class TestConnection:
    ...
    @pytest.mark.asyncio
    async def test_add_duplicate_model_returns_existing(self):
        """Test that adding a model that already exists directly returns the existing instance."""
    ...
    async def test_multiple_video_models_single_sending_track(self):
        ...
        with patch.object(YoloProvider, "connect", new_callable=AsyncMock):
            with patch.object(SamProvider, "connect", new_callable=AsyncMock):
